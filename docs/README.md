...
①
モデル名：User
カラム名：id:integer,name:string,email:string,password_digest:string,created_at:datetime,updated_at:datetime

②
モデル名：Task
カラム名：id:integer,name:string,user_id:integer,content:text,deadline:datetime,
status:string,priority:string,label:string,admin:boolean,created_at:datetime,updated_at:datetime
